...
//   /// Call this method to add/update age
//   Future<void> addAge({required String age}) async {
//     isLoading = true;
//     notifyListeners();

//     try {
//       final response = await apiService.addage(age: age);
...
//       } else {
//         debugPrint("⚠️ Failed to update age: ${response.data}");
//       }
//     } on DioException catch (e) {
//       debugPrint("❌ DioException in addAge: ${e.message}");
//     } catch (e) {
//       debugPrint("❌ Error in addAge: $e");
//     } finally {
//       isLoading = false;
//       notifyListeners();
//     }
